module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          'build/jobs.css': 'app/assets/sass/jobs.scss'
        }
      }
    },
    ...
    babel: {
      ...
      dist: {
        files: {
          'build/_<%= pkg.name %>.js': 'app/assets/js/components/_jobs.js'
        }
      }
    },
    concat: {
...
grunt.registerTask('subtaskJswww', ['eslint', 'handlebars', 'babel', 'concat:scripts',  'uglify']);
